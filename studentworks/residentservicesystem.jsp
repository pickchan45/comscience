        ...
        <div class="row">
            <div class="container">
                <div class="page-header">
                    <h1>Resident Service System</h1>
                </div>
            </div> 
            <div class="col-xs-12 col-sm-6 col-md-9">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/9rMfVNswsQQ?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
                </div>
                <br>
                <strong>ชื่อภาษาไทย</strong>
                <p>ระบบบริการหอพักออนไลน์</p>
                
                <strong>ชื่อภาษาอังกฤษ</strong>
                <p>Resident Service System</p>

                <strong>บทคัดย่อ</strong>
                <p>
                    ระบบบริการหอพักออนไลน์เป็นระบบที่ให้ความสะดวกสบายแก่ผู้ที่ต้องการค้นหาหอพักโดยไม่ต้องเดินหาหอพัก แต่เป็นการค้นหาหอพักที่ต้องการจากในระบบ โดยการค้นหาจากแขวง หรือ เขต นอกจากนี้ยังสามารถให้เจ้าของหอพักลงทะเบียนในระบบบริการหอพักออนไลน์เพื่อโปรโมทหอพักของตนเองได้อีกด้วย เป็นการไม่เสียรายได้จากการให้เช่าหอพักที่ควรจะได้รับ และผู้ใช้หอพักสามารถติดต่อการแจ้งข้อมูลห้องชำรุดและการแจ้งย้ายห้องหรือย้ายออกไม่จำเป็นต้องไปหากับเจ้าของหอโดยตรงแต่ใช้เป็นการติดต่อจากในระบบแทนเพื่อสะดวกแก่การแจ้งล่วงหน้า เนื่องจากการหาหอพักในปัจจุบันต้องอาศัยการลงไปในสถานที่จริงเพื่อสอบถามรายละเอียดแต่ถ้ามีระบบบริการหอพักออนไลน์ก็จะสามารถดูข้อมูลหอพักของหลายๆหอพักได้โดยไม่ต้องไปดูสถานที่จริง ถ้าหากสนใจหอพักใดก็จะมีเบอร์โทรศัพท์ของหอพักนั้นๆเพื่อให้ผู้ที่สนใจได้ติดต่อสอบถาม
                </p>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-3">
                <strong>ผู้พัฒนา</strong>
                <p>นางสาวพีรกานต์ รัดรอดกิจ<br>
                นางสาวคคนางค์ ทองสินธุ์<br>
                นางสาวศุภนิดา เชี่ยวสกุลวัฒนา</p>
        ...
        <div class="photo-gallery">
            <div class="row photos">
                <div class="col-lg-3 col-md-4 col-sm-6 item">
                    <a href="/comscience/images/studentworks/rss/1.png" data-lightbox="photos"><img class="img-responsive" src="/comscience/images/studentworks/rss/1.png"></a>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 item">
                    <a href="/comscience/images/studentworks/rss/2.png" data-lightbox="photos"><img class="img-responsive" src="/comscience/images/studentworks/rss/2.png"></a>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 item">
                    <a href="/comscience/images/studentworks/rss/3.png" data-lightbox="photos"><img class="img-responsive" src="/comscience/images/studentworks/rss/3.png"></a>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 item">
                    <a href="/comscience/images/studentworks/rss/4.png" data-lightbox="photos"><img class="img-responsive" src="/comscience/images/studentworks/rss/4.png"></a>
                </div>
            </div>
        </div>    
    </div> 
